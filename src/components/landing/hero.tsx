                ...
                >
                  ...
                  <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                    <button
                      ...
                      className="bg-gradient-to-b from-neutral-700 hover:from-neutral-600 to-neutral-900 text-white py-2 px-4  rounded-lg shadow hover:brightness-105 cursor-pointer transition-all"
                    >
                      <span className="text-sm">
                        Get Started Free{" "}
              ...
              <div className="bg-background group-data-[state=active]:block lg:group-data-[state=active]:flex mb-6 hidden w-full flex-wrap items-center justify-end space-y-8 rounded-3xl border p-6 shadow-2xl shadow-zinc-300/20 md:flex-nowrap lg:m-0 lg:flex lg:w-fit lg:gap-6 lg:space-y-0 lg:border-transparent lg:bg-transparent lg:p-0 lg:shadow-none dark:shadow-none dark:lg:bg-transparent">
                ...
                <div className="flex w-full flex-col space-y-3 sm:flex-row sm:gap-3 sm:space-y-0 md:w-fit lg:flex-row lg:items-center">
                  ...
                  <button
                    ...
                    className="w-full bg-gradient-to-b from-neutral-700 hover:from-neutral-600 to-neutral-900 text-white py-1 px-4 rounded-lg shadow hover:brightness-105 cursor-pointer transition-all"
                  >
